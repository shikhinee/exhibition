...
import { mediaByIndex, length, mediaPhotoCount , photoLength, photoByCount} from "@/components/Media4";
import { useNestedEmblaCarousel } from "@/components/NestedCarousel";
import CarouselThumb from "@/components/CarouselThumb"
//import STORE from '@/store'

import styles from './InnerCarousel4.module.scss'

const InnerCarousel4 = ({photos ,setLockParentScroll , count }) => {
