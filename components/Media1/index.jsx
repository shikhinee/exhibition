...
const image1 = {
    ...
    text: "Есөн Эрдэнийн Ганжуурыг бичгийн мэргэд тусгайлан боловсруулсан хар цаасан дээр алт, мөнгө, шүр, сувд, номин, оюу, зэс, ган, таныг нарийн жороор бэх болгон бэлдэж, мөрийг эгнүүлэн бичсэн бөгөөд монгол зургийн аргаар бурхан шүтээн, тахилын зураг, монгол хээ угалз сэлтийг уран сайхнаар дүрсэлсэн байдаг. 2002 онд Монгол Улсын Засгийн Газрын түүх соёлын “ХОСГҮЙ ҮНЭТ” өвд ЮНЕСКО-ийн “Дэлхийн Дурсамж” хөтөлбөрийн Олон улсын баримтат өвд 2013 онд бүртгэгджээ.",
    text1:"Холбогдох он цаг: 1819",
    text2:"Материал: Болгомол цаас, торго, даавуу, будаг, сарьс, гууль, есөн эрдэнэ",
    text3:"Хэмжээ: 70.5х16.5 см",
    text4:"Бичвэрийн хэмжээ 50х12 см, 110 боть",
}
const image2 = {
    ...
    text: "Есөн эрдэнээр бүтээсэн Жадамба нь МУҮНС-д хадгалагдаж буй эрдэнийн зүйлээр бичсэн хамгийн том хөлгөн судар юм. Судрын эхний болон сүүлчийн хуудсыг модоор хүрээлж торгоор бүрсэн ба хуудас бүрийг хоргой торгоор эмжиж хүрээлсэн байдаг. Xуудасны төв хэсэгт дугуй болон дөрвөлжин хүрээнд бурхадын  хөргийг зурж,  эхний хуудасны бичвэрийг зүмбэрээр товойлгож алтаджээ.",
    text1:"Хэмжээ: 90.5x33.4 см",
    text2:"",
    text3:"",
    text4:"",
}
...
const image5 = {
    ...
    text: "XIX зууны сүүлээр Манзуширын хийдэд Дагва тэргүүтэн дархчууд сүсэгтэн олны хандиваар цалин цагаан мөнгөн хуудсан дээр монгол дархны хөөмлийн аргаар өөрөөс нь үсэг товойлгон цохиж гаргаад алтдаж, бурхан бодисадын 50 хөргийг нарийн дүрслэн бүтээсэн судар юм. Нийт 1460 лан буюу 52 кг 560 гр алт, мөнгө орсон хэмээдэг. Монгол Улсын Засгийн Газрын 1995 оны 241-р тогтоолоор түүх соёлын ХОСГҮЙ ҮНЭТ өвд бүртгэжээ.",
    text1:"Хэмжээ: 59х15 см",
    text2:"",
    text3:"",
    text4:"",
}
const image6 = {
    ...
    text: "Уг судрыг гавж Самдан тэргүүтэн урчууд 1783 онд болгомол хар хөх цаасан дээр алтан үсгээр төвөдөөр бичиж, хоёр талын зандан модон хавтсыг ухаж сийлэн, хээ угалз, цэцэг навчийг зуран, маанийн зургаан үсгийг ланз үсгээр бичиж чимэглэн бүтээжээ. Судрын эргэн тойронд найман тахил, чандмань эрдэнэ, намжвандан зэргийг бадам цэцгийн сууринд өнгө ялган хээ угалзаар чимэглэн дүрсэлжээ. Монгол Улсын Засгийн Газрын 2012 оны 105-р тогтоолоор түүх соёлын ХОСГҮЙ ҮНЭТ өвд бүртгэжээ.",
    text1:"Материал: Болгомол хар цаас, алт, мод",
    text2:"Хэмжээ: 62.2х17.8 см,269 хуудас",
    text3:"",
    text4:"",
}
const image7 = {
    ...
    text: "МУҮНС-д хадгалагдаж буй алтаар монгол бичгээр бичсэн хамгийн том дурсгал юм. Тус бүтээлийг 1894 он буюу Бадаргуулт төрийн 20-p он хөх морин жилийн намрын дунд сарын сайн өдөр бичиж төгсгөжээ. Монгол Улсын Засгийн Газрын 2012 оны 105-р тогтоолоор түүх соёлын ХОСГҮЙ ҮНЭТ өвд бүртгэжээ.",
    text1:"Материал: Болгомол хар цаас, алт",
    text2:"Хэмжээ: 53.6х17.3 см,256 хуудас",
    text3:"Мөрийн тоо:20",
    text4:"",
}
const image8 = {
    ...
    text: "Яруу найрагч Цогдоржийн Бавуудорж 2005 оны 11-р сард дүү Ц. Рэнцэнбавуу, Ц. Рэнцэнноров нарын хамт “Монголын их амар амгалан” шүлгээ зэс хуудсан дээр мөнгөн утсаар бичиж, хуудас бүрийн эхэнд мөнгөн бурханыг суулган эрдэнийн чулуугаар чимэглэжээ.",
    text1:"Хэмжээ: 40.2х11.4 см",
    text2:"Бичвэрийн хэмжээ26.3х7.5 см",
    text3:"6 хуудас",
    text4:"",
}
const image9 = {
    ...
    text: "Доржжодба буюу монголчилбол “Очироор огтлогч” хэмээн нэрлэдэг. Алтан үсгээр монгол бичгээр бичсэн ховор дурсгалуудын нэг юм.",
    text1:"Материал: Болгомол хар цаас, алт, мод, торго",
    text2:"Хэмжээ: 24.5х9.8 см",
    text3:"Бичвэрийн хэмжээ 17.8х6.6 см",
    text4:"81 хуудас",
}
